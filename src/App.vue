    ...
    <main>
      <div class="search-box">
        <input type="text" 
                ...
                placeholder="Search..."
                v-model="query"
                @keypress="fetchWeather"/> <!-- same as v-on:keypress -->
      </div>

      <div class="weather-wrap" v-if="typeof weather.main != 'undefined'"> <!-- only displays if api call does not return undefined  -->
